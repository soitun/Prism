...
class Ui_w_sceneBrowser(object):
    def setupUi(self, w_sceneBrowser):
        ...
        self.splitter_5 = QSplitter(w_sceneBrowser)
        self.splitter_5.setObjectName(u"splitter_5")
        self.splitter_5.setOrientation(Qt.Horizontal)
        self.verticalWidget_3 = QWidget(self.splitter_5)
        ...
        self.splitter_2 = QSplitter(self.verticalWidget_3)
        self.splitter_2.setObjectName(u"splitter_2")
        self.splitter_2.setOrientation(Qt.Vertical)
        self.horizontalWidget_2 = QWidget(self.splitter_2)
        ...
        self.splitter = QSplitter(self.horizontalWidget_2)
        self.splitter.setObjectName(u"splitter")
        self.splitter.setOrientation(Qt.Horizontal)
        self.widget_23 = QWidget(self.splitter)
        ...
        self.splitter.addWidget(self.widget_23)
        ...
        self.splitter_2.addWidget(self.horizontalWidget_2)
        self.gb_entityInfo = QGroupBox(self.splitter_2)
        ...
        self.splitter_2.addWidget(self.gb_entityInfo)

        self.verticalLayout_2.addWidget(self.splitter_2)

        self.splitter_5.addWidget(self.verticalWidget_3)
        self.widget_4 = QWidget(self.splitter_5)
        ...
        self.splitter_5.addWidget(self.widget_4)
